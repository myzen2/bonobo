...
namespace App\BonoboBundle\Controller;

use App\BonoboBundle\Entity\Bonobo;
...
class BonoboController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $bonobos = $em->getRepository('AppBonoboBundle:Bonobo')->findAll();
    ...
    {
        $bonobo = new Bonobo();
        $form = $this->createForm('App\BonoboBundle\Form\BonoboType', $bonobo);
    ...
    {
        $deleteForm = $this->createDeleteForm($bonobo);
        $editForm = $this->createForm('App\BonoboBundle\Form\BonoboType', $bonobo);
